...
//neighbor
      NodeList neighborList = root.getElementsByTagName("neighbor");
...
//done w/ neighbors
//area
System.out.println(setName + " " + neighborList+ "\n");
...
NodeList takeList = root.getElementsByTagName("take");
...
System.out.println(setName+" "+neighborNames[0]);
  rooms[i] = r;
